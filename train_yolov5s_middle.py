...
from models.my_yolov5_2backbone_full_transfer import build_yolov5s_2backbone   # 2 backbone input model
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = build_yolov5s_2backbone().to(device)     # # 2 backbone input model
