...
class build_yolov5s_2conv_simple(nn.Module):
    def __init__(self, cfg='models/yolov5s_2conv.yaml', ch=6, nc=1, anchors=None):
        super().__init__()
        ...
        self.model, self.save = parse_model_modified(deepcopy(self.yaml), ch=[ch])  # model, savelist
...
def parse_model_modified(d, ch):  # model_dict, input_channels(6)
